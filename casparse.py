...
class SparseCorrespondenceAnalysis(object):
    def __init__(self, ct, n_components=0):
        self.mat_name_list=[]
        ...
        self.dimuse=n_components

        if issparse(ct): 
            N=ct
        elif isdelayedspmatrix(ct):
            N=ct
        ...
        self.U, self.D, self.Vt = extmath2.randomized_svd(S, n_components)
...
def _test():
    ...
    cad=SparseCorrespondenceAnalysis(c1,3)
    print(cad.D)
    print(cad.U)
    print(cad.Vt)
